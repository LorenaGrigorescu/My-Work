...
void testAdaugaSiCauta(Relatie r) {
    ...
    std::cout<<"End test adaugaresi cauta!\n";
}

void testAdauga() {
	testAdaugaSiCauta(cresc);
	testAdaugaSiCauta(desc);
    std::cout<<"End test adauga!\n";
}
...
void testStergeCauta(Relatie r) {
	...
	assert(d.vid());
	assert(d.dim() == 0);
    std::cout<<"End test sterge cauta!\n";
}

void testSterge() {
	testStergeCauta(cresc);
	testStergeCauta(desc);
    std::cout<<"End test sterge!\n";
}
